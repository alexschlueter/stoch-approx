...
Dreiecksungleichung und die Jensensche Ungleichung kann für $x\in I$ man abschätzen
 \begin{align*}
...
\begin{equation*}
  \kappa_n^{2+\delta} \sum_{j=1}\condexp{\abs{\Delta M}^{2+\delta}}{\ff_{j-1}}\to 0\quad\text{f.s.}
\end{equation*}
...
\end{equation*}
Mit der Konvergenz der beiden anderen Terme gegen $0$ folgt die Behauptung mittels \cref{cor:mischsum}.
\end{proof}
\begin{rem}
